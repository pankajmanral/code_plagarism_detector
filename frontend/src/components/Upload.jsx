      ...
      <div className="glass-panel p-6 md:p-8">
        ...
        {method === 'text' ? (
          ...
          <div className="flex flex-col items-center justify-center p-12 border-2 border-dashed border-slate-700 rounded-xl bg-slate-900/50 hover:bg-slate-800/50 transition-colors">
            ...
            <p className="text-slate-300 font-medium mb-2 text-center text-lg">Drag & drop python files here</p>
        ...
        <div className="mt-8 flex justify-center">
          <button
            ...
            disabled={loading || (method === 'text' && (!code1 || !code2)) || (method === 'file' && files.length < 2)}
